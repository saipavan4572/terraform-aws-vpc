...
![alt text](images/Session-28-vpc_module_diagram-2.jpeg)

This module is developed for joindevops.com. We are creating following resources. This module creates resources in first 2 AZ(availability zones) for HA(high availability).
